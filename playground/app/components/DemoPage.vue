<template>
    ...
    >
        <div
            class="
                flex min-w-0 grow flex-col gap-10 px-6 py-12
                lg:px-10
            "
        >
        ...
        <aside
            class="
                sticky bottom-0 z-20 flex max-h-[45vh] flex-none flex-col border-t
                border-contrast/10 bg-background p-4
                xl:top-0 xl:bottom-auto xl:h-screen xl:max-h-none xl:w-[26rem]
                xl:self-start xl:border-t-0 xl:border-l
            "
        >
            <slot
                name="output"
...
<script setup lang="ts">
    ...
    provide(demoSourceKey, toRef(() => props.source));
